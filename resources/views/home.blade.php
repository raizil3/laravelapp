    ...
    <div class="container-fluid position-relative p-0 ">
        {{-- <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0 sticky-top shadow-sm">
            <a href="/" class="navbar-brand p-0">
                <h1 class="m-0"> <img class="img-fluid rounded m-2" type="image/png" id="curva_logo"
                        src="{{ url('images/curva_logo.png') }}" style="width: 50px; height: 50px;" alt="Image">Curva
                    NHS</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="{{ route('login') }}" class="btn btn-primary py-2 px-4 ms-3"><i
                        class="fa fa-user-tie me-2"></i>Log in</a>
            </div>
        </nav> --}}
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item ">
                    <img class="w-100 img-fluid" type="image/jpg"
                        src="{{ url('images/background_resize.jpg') }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Creative & Innovative Digital
